        ...
        <div class="col-md-6 card p-mobile">
            ...
            <div id="saman-row-pos" class="rqw mt-1">
                <div class="col p-mobile">
                    <table id="pos_list" class="table-responsive tfr pos_stripe border" style="
    height: 400px;
    overflow-y: auto;
>
                        <thead>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-6">
                            <span id="totalQty" class="lightMode">0</span></div>
                    </div>
                    <div class="row mt-1">
                        <div class="col-3">
                        ...
                        <div class="col-6">
                            <span id="totalitems" class="lightMode">0</span></div>
                    </div>
                    <div class="row mt-1">
        ...
        <div class="col-md-6 card  order-sm-first  order-md-2 border-amber bg-lighten-1 bg-faded round pt-1">
            ...
            <div class="row">
                <div class="col-md-12 pt-0" id="pos_item" style="
    overflow: scroll;
    height: 1000px;
">
                    <!-- pos items -->
                ...
                <div class="modal-body">
                    ...
                    <label for="account_p"><?php echo $this->lang->line('Account') ?></label>
                            ...
                            <select name="p_account" id="p_account" class="form-control">
                                <?php 
                                echo '<option value="' . $def_account['id'] . '">' . $def_account['holder'] . ' / ' . $def_account['acn'] . '</option>';
                                foreach ($acc_list as $row) {
                                    if($def_account['id'] != $row['id'])
