                ...
                <div class="row">
                    ...
                    <div class="">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            <?php if ($delivery_boy['assigned'] == 0) { ?>
                                <div class="btn-group ">
                                    <button type="button" class="btn btn-primary mb-1 btn-min-width dropdown-toggle"
                                    ...
                                    <div class="dropdown-menu">
                                    <?php 
                                        foreach ($delivery_boys as $dby) { ?>
                                            <a class="dropdown-item"
                                        href="<?= base_url() . 'DeliveryBoys/assignboy?tid=' . $id . '&boyid=' . $dby['boy_id']; ?>"><?php echo $dby['boy_name'] ?></a>
                            ...
                            <?php } else { ?>
                                <div class="btn-group ">
                                    ...
                                    <?php 
                                        foreach ($delivery_boys as $dby) { ?>
                                        <?php if ($delivery_boy['boy_id'] != $dby['boy_id']) { ?>
                                            <a class="dropdown-item"
                                        href="<?= base_url() . 'DeliveryBoys/updateboy?tid=' . $id . '&boyid=' . $dby['boy_id']; ?>"><?php echo $dby['boy_name'] ?></a>
...
//Added by Hussain - added a new column to table geopos_transaction (transDateTime) tp save dateTime 
                            $dateGMT = new DateTime($row['transDateTime']);
                            $dateGMT->setTimezone( new DateTimeZone( 'Asia/Calcutta' ) );
                            echo '<tr>
                            <td><a href="view_payslip?id=' . $row['id'] . '&inv=' . $invoice['iid'] . '" class="btn btn-blue btn-sm"><span class="icon-print" aria-hidden="true"></span> ' . $this->lang->line('Print') . '  </a> ' . $dateGMT->format('Y-m-d H:i:s') . '</td>
