                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body text-left w-100">
                                            <h3 class="success"><?= amountExchange($todayshipping, 0, $this->aauth->get_user()->loc) ?></h3>
                                            <span>Today Shipping</span>
                                        </div>
                ...
                <div class="table-responsive">
                    <table id="recent-orders" class="table table-hover mb-1">
                        ...
                        foreach ($recent as $item) {
                            ...
                            $date1 = new DateTime($item['invoicedatetime']);
                            $formattedDate = $item['invoicedatetime'] ? $date1->format('d-m-Y h:i:s A') : '';
                            echo '    <tr>
