...
class Dashboard_model extends CI_Model
{
    ...
    public function todayShipping($today)
    {
    ...
    public function recentInvoices()
    {
        ...
        $query = $this->db->query("SELECT i.id,i.tid,i.invoicedate,i.invoicedatetime,i.total,i.status,i.i_class,c.name,c.picture,i.csd
